...
<head>
    ...
    @production
        <script type="text/javascript">var _jf = _jf || [];
            _jf.push(['p', '52580']);
            _jf.push(['initAction', true]);
            _jf.push(['_setFont', 'wt064', 'css', '.wt064']);
            _jf.push(['_setFont', 'wt064', 'alias', 'wt064']);
            _jf.push(['_setFont', 'wt064', 'english', 'Roboto']);
            _jf.push(['_setFont', 'wt064', 'weight', 700]);
            _jf.push(['_setFont', 'setofont', 'css', '.setofont']);
            _jf.push(['_setFont', 'setofont', 'alias', 'setofont']);
            _jf.push(['_setFont', 'setofont', 'english', 'Roboto ']);
            _jf.push(['_setFont', 'setofont', 'weight', 600]);
            (function (A, p, c, m, l, q, r, h, B, D) {
                var b = A._jf;
                if (b.constructor !== Object) {
                    var t = !0, u = function (a) {
                            var f = !0, e;
                            for (e in b) b[e][0] == a && (f && (f = f && !1 !== b[e][1].call(b)), b[e] = null, delete b[e])
                        }, v = /\S+/g, w = /[\t\r\n\f]/g, C = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, n = "".trim,
                        x = n && !n.call("\ufeff\u00a0") ? function (a) {
                            ...
                            if (0 === arguments.length || "string" === typeof a && a) {
                                ...
                                if (b = h[c] ? (" " + h[c] + " ").replace(w, " ") : "") {
                                    for (g = 0; e = d[g++];) for (; 0 <= b.indexOf(" " + e + " ");) b = b.replace(" " + e + " ", " ");
                                    h[c] = a ? x(b) : ""
                                }
                            }
                        }, y;
                    b.addScript = y = function (b, f, e, g, d, c) {
                        ...
                        var a = p.createElement("script"), h = p.getElementsByTagName("script")[0], k, m = !1,
                            l = function () {
                                a.src = "";
            ...
            })(this, this.document, "className", "jf-loading", "jf-reloading", "jf-active", "jf-inactive", this.document.getElementsByTagName("html")[0], "//ds.justfont.com/js/stable/v/6.1/id/228051997753");</script>
    @endproduction
