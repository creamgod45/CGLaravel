...
class DictionaryMap
{
    ...
    public function __construct(I18N &$i18N)
    {
        ...
        $i->setLanguagev2(ELanguageText::sendMailVerifyCodeNotEqualValue, "The %validator_field_VerificationCode% is invalid value");
        $i->setLanguagev2(ELanguageText::BooleanStringCoverFalse, "Disable");
        $i->setLanguagev2(ELanguageText::BooleanStringCoverTrue, "Enable");
        $i->setLanguagev2(ELanguageText::CSRFVerificationFailed, "CSRF verification failed");
        $i->setLanguagev2(ELanguageText::DataReceivedSuccessfully, "Data Received Successfully");
        ...
        $i->setLanguagev2(ELanguageText::GetLanguage, "Get Language");
        ...
        $i->setLanguagev2(ELanguageText::registerDone, "Registration is successful. Please verify your email address!! Verification will expire in 1 hour");
        ...
        $i->setLanguagev2(ELanguageText::UserAccountBanMessage, "Your account has been deactivated, so you have been forced to log out.");
        ...
        $i->setLanguagev2(ELanguageText::ValidatorBuilderFailed, "Verification failed");
