...
class ValidatorBuilder
{
    ...
    private function initAtters(): array
    {
        return [
            ...
            'sendMailVerifyCodeToken' => $this->i18N->getLanguage(ELanguageText::validator_field_sendMailVerifyCodeToken), // "信箱身份驗證權杖"
            'code' => $this->i18N->getLanguage(ELanguageText::validator_field_VerificationCode),
            'lang' => $this->i18N->getLanguage(ELanguageText::menu_language)
        ];
    }
